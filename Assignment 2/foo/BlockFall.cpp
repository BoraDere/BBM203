...
void BlockFall::read_blocks(const string &input_file) {
    ...
    // while(firstBlock->next_block != nullptr) {
    //     Block* b1 = new Block(rotate(firstBlock));
    //     Block* b2 = new Block(rotate(b1));
    //     Block* b3 = new Block(rotate(b2));

    //     firstBlock->right_rotation = b1;
    //     b1->right_rotation = b2;
    //     b2->right_rotation = b3;
    //     b3->right_rotation = firstBlock;

    //     firstBlock->left_rotation = b3;
    //     b1->left_rotation = firstBlock;
    //     b2->left_rotation = b1;
    //     b3->left_rotation = b2;

    //     firstBlock = firstBlock->next_block;
    // }
