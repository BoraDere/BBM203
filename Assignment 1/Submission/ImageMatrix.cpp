...
// Defining this simple function saved my life. I was having a hard time with using the overloaded operators.
// I believe you have prepared them at the first place for addition, subtraction etc. but I could not use them.
// Since you have said that we can define as many functions as we wish, I have defined this function and used it.
// Still, as you can see, I tried to implement those functions. I just did not use them.
